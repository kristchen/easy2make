...
from .views import ProdutoListAPI, ProdutoCreate, ProdutoUpdate, ProdutoList, CategoriaCreate, CategoriaUpdate, CategoriaList
...
urlpatterns = [
    ...
    path('produtos/', ProdutoListAPI.as_view()),
